...
<body>
    <?php
    $xml= simplexml_load_file('Ledesma-Manahan_IT2C_Cake Shop/ourservice.xml');
    ?>
    <!-- Topbar Start -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    ...
                    <a href="custom.php" class="btn btn-primary border-inner py-3 px-5"><?php echo $xml->navbar->button6; ?></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid about py-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                ...
                <h1 class="display-4 text-uppercase"><?php echo $xml->navbar->wedding; ?></h1>
            </div>
                    ...
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-3">
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/boho2.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/buttt.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price7; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->butter; ?></h5>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/3.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price8; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->classic; ?></h5>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/naked.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price9; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->rust; ?></h5>
    ...
    <div class="container-fluid about py-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                <h2 class="text-primary font-secondary"><?php echo $xml->navbar->menu1; ?></h2>
                <h1 class="display-4 text-uppercase"><?php echo $xml->navbar->bday; ?></h1>
            </div>
            <div class="tab-class text-center">
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/al.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price7; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->alpha; ?></h5>
                                        <span><?php echo $xml->navbar->content5; ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/cup.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price8; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/omb.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price9; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->ombre; ?></h5>
                                        <span><?php echo $xml->navbar->content7; ?></span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0"><?php echo $xml->navbar->emailus; ?></p>
                            </div>
                            <div class="d-flex mb-2">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            <h4 class="text-primary text-uppercase mb-4">Q<?php echo $xml->navbar->quicklinks; ?></h4>
