...
<body>
    <?php
    $xml= simplexml_load_file('Ledesma-Manahan_IT2C_Cake Shop/index.xml');
    ?>
    <!-- Topbar Start -->
            ...
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="service.php" class="dropdown-item"><?php echo $xml->navbar->ours; ?></a>
        ...
        <div class="container">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <h4 class="mb-4"><?php echo $xml->navbar->welcome; ?></h4>
        ...
        <div class="container">
            ...
            <div class="tab-class text-center">
                <ul class="nav nav-pills d-inline-flex justify-content-center bg-dark text-uppercase border-inner p-4 mb-5">
                    <li class="nav-item">
                        <a class="nav-link text-white active" data-bs-toggle="pill" href="birthday.php"><?php echo $xml->navbar->button3; ?></a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->twotier; ?></h5>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase"><?php echo $xml->navbar->classicthreetier; ?></h5>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-12 col-md-6 text-center">
                    ...
                    <a href="menu&price.php" class="btn btn-primary border-inner py-3 px-5"><?php echo $xml->navbar->button6; ?></a>
                </div>
            </div>
        </div>
    </div>
