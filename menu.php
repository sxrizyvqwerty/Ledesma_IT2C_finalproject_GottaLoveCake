...
<body>
    <?php
    $xml= simplexml_load_file('Ledesma-Manahan_IT2C_Cake Shop/menu.xml');
    ?>
    <!-- Topbar Start -->
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto mx-lg-auto py-0">
                ...
                <a href="menu.php" class="nav-item nav-link active"><?php echo $xml->navbar->menu; ?></a>
    ...
    <div class="container-fluid bg-dark bg-img p-5 mb-5">
        <div class="row">
            <div class="col-12 text-center">
                <h1 class="display-4 text-uppercase text-white"><?php echo $xml->navbar->menu; ?></h1>
                <a href="">Home</a>
                <i class="far fa-square text-primary px-2"></i>
                <a href=""><?php echo $xml->navbar->menu; ?></a>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container-fluid about py-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                <h2 class="text-primary font-secondary"><?php echo $xml->navbar->menu; ?></h2>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/about2.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <img class="img-fluid" src="img/cake-3.jpg" alt="" style="width: 150px; height: 85px;">
                                        <h4 class="bg-dark text-primary p-2 m-0"><?php echo $xml->navbar->price17; ?></h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
            ...
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 mt-lg-n5">
                    <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary border-inner p-4">
                        ...
                        <p class="mt-3"><?php echo $xml->navbar->description4; ?></p>
                    </div>
                </div>
