...
<body>
    <?php
    $xml= simplexml_load_file('Ledesma-Manahan_IT2C_Cake Shop/birthday.xml');
    ?>
    <!-- Topbar Start -->
                    ...
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        <?php echo '<img class="img-fluid" src="img/mocha.jpg" alt="" style="width: 150px; height: 85px;">'; ?>
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                            <h4 class="text-primary text-uppercase mb-4"></h4>
