...
<body>
    <?php
    $xml= simplexml_load_file('Ledesma-Manahan_IT2C_Cake Shop/privacypolicy.xml');
    ?>
    <!-- Topbar Start -->
            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-7 text-center">
                    <div class="section-title position-relative text-center mx-auto mb-4 pb-3" style="max-width: 600px;">
                        <h2 class="text-primary font-secondary"><?php echo $xml->navbar->privacy1; ?></h2>
                        <h1 class="display-4 text-uppercase text-white"><?php echo $xml->navbar->privacy1; ?></h1>
                    </div>
                    <p class="text-white mb-4"><?php echo $xml->navbar->privacy; ?></p>
                    <a href="index.php" class="btn btn-primary border-inner py-3 px-5 me-3"><?php echo $xml->navbar->button7; ?></a>
                    <a href="privacy.php" class="btn btn-dark border-inner py-3 px-5"><?php echo $xml->navbar->button8; ?></a>
                </div>
            </div>
        </div>
    </div>
